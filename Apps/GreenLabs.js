...
window.GreenLabs = (() => {
  const labs = [
    ...
    { id: "digifried", title: "digiFried 2.0", category: "Daten & Monitoring", icon: "cube", image: "Images/labs/digifried-2-960.webp", badge: "Vorhaben", project: true,
      ...
      subprojects: [{ title: "Friedhofsmanagement Melaten", badge: "Unterprojekt", image: "Images/labs/digifried-cemetery-management-960.webp",
        ...
        description: "Interaktive Fachanwendung für einen schematischen digitalen Arbeitsplan des Melaten-Friedhofs. Flächenbezogene Einträge werden nachvollziehbar von amtlich vermessenen Einzelgräbern unterschieden.",
        features: [["map", "Fluren & Parzellen", "157 digitalisierte Flurflächen, Statusfilter und klickbare Detailansichten"],
          ["list", "Grabregister & Fristen", "Belegung, Ruhefristen, Schutzmerkmale sowie Ehren- und Kriegsgräber"],
          ["report", "Bauhof & Aufgaben", "Priorisierte Arbeitsaufträge für Kontrollen, Pflege und Beisetzungsvorbereitung"],
          ["chart", "Analyse & Datenaustausch", "Datenqualität, Fristen, Belegung sowie Sicherung, Import und GeoJSON-Export"]] }] },
  ];
  ...
  function previewPanel(lab) {
    ...
    const interactiveFile = { watering: "smart-watering-pilot.html", monitoring: "gruenflaechen-monitoring.html" }[lab.id];
